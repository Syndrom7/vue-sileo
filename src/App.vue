...
<template>
	...
	<div class="page" :data-theme="isDark ? 'dark' : 'light'">
		<!-- Nav -->
		<nav class="nav">
			<span class="nav-brand">sileo-vue</span>
			<div class="nav-links">
				<a href="#examples">Examples</a>
				<a href="#builder">Builder</a>
				<a href="#docs">Docs</a>
				<a href="https://github.com/Syndrom7/sileo-vue" target="_blank" rel="noopener" class="nav-icon" title="GitHub">
				...
				<a href="https://www.npmjs.com/package/sileo-vue" target="_blank" rel="noopener" class="nav-icon" title="npm">
		...
		<header class="hero">
			...
			<h1 class="hero-title">sileo-vue</h1>
			...
			<button class="install-btn" @click="copyInstall">
				<span class="install-prefix">$</span> npm install sileo-vue
